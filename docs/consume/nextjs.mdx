...
<UnderConstruction 
  message={
    <span>
      Osso is not yet completely supported by NextAuth.js - we have{' '}
      <a href="https://github.com/nextauthjs/next-auth/pull/928">an open PR</a>{' '}
      you can help us get merged 🙏
    </span>
  } 
/>

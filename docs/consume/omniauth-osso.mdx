...
Then configure your Osso instance in an `OmniAuth::Builder` block. Get your Client ID and Client Secret from your Osso instance's OAuth clients page and store them in your application's environment. You can also put your 

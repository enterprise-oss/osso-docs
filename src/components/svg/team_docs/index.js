...
export default () => {
  ...
  return (
    <svg ref={ref} className={classnames(styles.svg, { [styles.active]: inView })} width="448" height="285" viewBox="0 0 448 285" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path fill-rule="evenodd" clip-rule="evenodd" d="M251 27C251 41.9117 238.912 54 224 54C209.088 54 197 41.9117 197 27C197 12.0883 209.088 0 224 0C238.912 0 251 12.0883 251 27ZM247 27C247 39.7025 236.703 50 224 50C211.297 50 201 39.7025 201 27C201 14.2975 211.297 4 224 4C236.703 4 247 14.2975 247 27Z" className={styles.svgElem2}></path>
      ...
      <path fill-rule="evenodd" clip-rule="evenodd" d="M251 149C251 163.912 238.912 176 224 176C209.088 176 197 163.912 197 149C197 134.088 209.088 122 224 122C238.912 122 251 134.088 251 149ZM247 149C247 161.703 236.703 172 224 172C211.297 172 201 161.703 201 149C201 136.297 211.297 126 224 126C236.703 126 247 136.297 247 149Z" className={styles.svgElem4}></path>
      ...
      <path fill-rule="evenodd" clip-rule="evenodd" d="M345 105C345 119.912 332.912 132 318 132C303.088 132 291 119.912 291 105C291 90.0883 303.088 78 318 78C332.912 78 345 90.0883 345 105ZM341 105C341 117.703 330.703 128 318 128C305.297 128 295 117.703 295 105C295 92.2975 305.297 82 318 82C330.703 82 341 92.2975 341 105Z" className={styles.svgElem8}></path>
      <line x1="223" y1="64" x2="223" y2="108" stroke="#FFCD83" stroke-width="4" stroke-linecap="round" className={styles.svgElem9}></line>
      <line x1="2" y1="-2" x2="46" y2="-2" transform="matrix(0.764291 0.644871 0.644871 -0.764291 252 48)" stroke="#FFCD83" stroke-width="4" stroke-linecap="round" className={styles.svgElem10}></line>
      <line x1="195.761" y1="50.8183" x2="162.132" y2="79.1926" stroke="#FFCD83" stroke-width="4" stroke-linecap="round" className={styles.svgElem11}></line>
      ...
      <path fill-rule="evenodd" clip-rule="evenodd" d="M150 258C150 272.912 162.088 285 177 285C191.912 285 204 272.912 204 258C204 243.088 191.912 231 177 231C162.088 231 150 243.088 150 258ZM154 258C154 270.703 164.297 281 177 281C189.703 281 200 270.703 200 258C200 245.297 189.703 235 177 235C164.297 235 154 245.297 154 258Z" className={styles.svgElem23}></path>
      <line x1="2" y1="-2" x2="46" y2="-2" transform="matrix(0.898385 0.43921 0.43921 -0.898385 348.544 116)" stroke="#FFCD83" stroke-width="4" stroke-linecap="round" className={styles.svgElem24}></line>
      <line x1="98.5377" y1="118.675" x2="59.0088" y2="138" stroke="#FFCD83" stroke-width="4" stroke-linecap="round" className={styles.svgElem25}></line>
      <line x1="2" y1="-2" x2="46" y2="-2" transform="matrix(0.333728 0.942669 0.942669 -0.333728 332 136.853)" stroke="#FFCD83" stroke-width="4" stroke-linecap="round" className={styles.svgElem26}></line>
      <line x1="117.218" y1="139.406" x2="102.534" y2="180.883" stroke="#FFCD83" stroke-width="4" stroke-linecap="round" className={styles.svgElem27}></line>
      <line x1="2" y1="-2" x2="46" y2="-2" transform="matrix(0.407679 0.913125 0.913125 -0.407679 239 181)" stroke="#FFCD83" stroke-width="4" stroke-linecap="round" className={styles.svgElem28}></line>
      <line x1="210.011" y1="183.642" x2="192.073" y2="223.819" stroke="#FFCD83" stroke-width="4" stroke-linecap="round" className={styles.svgElem29}></line>
    </svg>
  )
}
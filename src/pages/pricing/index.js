          ...
          <Collapse
            ...
            expandIcon={({ isActive }) => (
              <RightOutlined
                ...
                style={{ color: "var(--ifm-landing-page-font-color)" }}
              />
            )}
          >
            <Collapse.Panel
            ...
            >
              <p className={styles.panelContent}>
                ...
                Accounts that use your existing authentication flow do not count
                as customers for Osso.
              </p>
            </Collapse.Panel>
            <Collapse.Panel
              header={
            ...
            >
              <p className={styles.panelContent}>
                No. Whether your customer has 10 or 10,000 users, they’ll still
                count as just one customer to us. We don’t want to charge you
                more because your software is a daily driver, and charging per
                customer provides a more predictable pricing for your
                subscription.
              </p>
            </Collapse.Panel>
            <Collapse.Panel
            ...
            >
              <p className={styles.panelContent}>
                ...
                fine; they’ll all be folded into that single customer’s account
                and won’t count additionally against your quota.
              </p>
            </Collapse.Panel>
            <Collapse.Panel
              header={
            ...
            >
              <p className={styles.panelContent}>
                We understand you might have test accounts or proofs of concept
                running with certain customers, so we won’t cut you off if you
                surpass your limit. When that happens we’ll reach out and work
                with you to move you to the next tier.
              </p>
            </Collapse.Panel>
            <Collapse.Panel
              header={
                <span className={styles.panelTitle}>
                  We want to implement SAML, but don't have any active customers
                  who need it - do I still have to pay?
                </span>
              }
              key="5"
              className={styles.panel}
            >
              <p className={styles.panelContent}>
                ...
                that allows you to build and test your Osso integration without
                needing to purchase a subscription. Once you have a customer who
                needs SAML, you can purchase a subscription, change some ENV
                variables and immediately start onboarding customers.
              </p>
            </Collapse.Panel>
          </Collapse>
        </Col>
      ...
      <Row>
        <Col sm={24} md={{ span: 16, offset: 4 }} className={styles.features}>
          ...
          <p>
            ...
            remain a free, open source piece of software that anyone can use by
            deploying to their own infrastructure. Check out our{" "}
            <a

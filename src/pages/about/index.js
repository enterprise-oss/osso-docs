    ...
    >
      ...
      <Row>
        <Col sm={24} md={{ span: 16, offset: 4 }} className={styles.section}>
          ...
          <p>
            After losing work due to the pandemic, we founded Osso with the goal
            of working together on something that could help other business
            owners as they grew their own companies. After a few months of user
            research, development time, and QA, we launched to help make SAML
            SSO more accessible to startups at all stages of growth.
          </p>
          <p>
          ...
          <Row gutter={[16, 0]}>
            ...
            <Col xs={12} md={6}>
              ...
              >
                ...
                <p className={styles.prev}>
                  Previously:
                  <br /> Product design @ WeWork, Founder @ The UpStanding Desk
                </p>
                <div className={styles.social}>
                  <a
                    target="_blank"
